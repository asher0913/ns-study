...
df = pd.read_csv('simulation_basic_scenario.csv')
df_plot = df[df['No. of run'] != 'Average']
df_plot = df_plot.set_index('No. of run')
...
plt.title('Network Metrics by Running Basic Scenario 20 Times')
